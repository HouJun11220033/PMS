...
<body>
	<fieldset>
		<legend>表单验证</legend>
		<form id="userForm" name="user" method="post"></form>
		<table>
			<tr>
				<td>用 户 名</td>
			...
			<tr>
				<td>身份证号码：</td>
				<td><input type="text" name="123" id="idnumber" onBlur="return checkIdnumber()" /></td>
				<td><span id="idcheck">* 请输入18位身份证号码</span></td>
			</tr>
			<tr>
				<td>手机号码：</td>
				<td><input type="text" name="456" id="phnumber" onBlur="return checkphnumber()" /></td>
