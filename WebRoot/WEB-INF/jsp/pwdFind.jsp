...
<div class="login">
	...
	<div class="login-top">
		...
		<form action="show" method="post">
			<input type="text" name="username" value="请输入你的手机号码" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'User Id';}">
			<input type="password" name="password" value="请输入你的身份证号码" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'password';}">
	    </form>
	    <div class="forgot">
	    	${hint}
